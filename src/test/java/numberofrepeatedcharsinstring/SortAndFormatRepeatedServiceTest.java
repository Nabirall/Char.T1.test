...
class SortAndFormatRepeatedServiceTest {
    ...
    void assertSortAndFormatResultReturnsLinkedHashMap() {
        Map<Character, Integer> sortedCharsToQuantity = sortAndFormatRepeatedService.sortAndFormatResult(CHARS_TO_QUANTITY);
    ...
    void assertGetSortedCharsReturnsEmptyLinkedHashWhenIncomingMapIsEmpty() {
        Map<Character, Integer> sortedCharsToQuantity = sortAndFormatRepeatedService.sortAndFormatResult(new HashMap<>());
    ...
    void assertGetSortedCharsThrowsNullPointerExceptionWhenNullIsPassedToArgument() {
        Assertions.assertThrows(NullPointerException.class, () -> sortAndFormatRepeatedService.sortAndFormatResult(null));
    }
